...
@Order(3)
@Transactional
public class FakeUserEntityGenerator implements CommandLineRunner {

    private static final Logger log = LoggerFactory.getLogger(FakeUserEntityGenerator.class);
    ...
    public FakeUserEntityGenerator(
    ...
    @Override
    @Transactional
    public void run(String... args) throws InvalidModuleAssignmentException, UserModuleAlreadyExistException, UserAlreadyExistException {
