...
//                        .requestMatchers(HttpMethod.GET, "/", "/v3/api-docs", "/v3/api-docs/**", "/swagger-ui/index.html", "/swagger-ui/**").permitAll()
                                ...
                                .requestMatchers(HttpMethod.GET, "/ai/compare/analysis").permitAll()
                                .requestMatchers(HttpMethod.GET, "/users/all", "/users/all/details", "/users/me/details", "/users/get", "/users/get/details").permitAll()
                                .requestMatchers(HttpMethod.GET, "/users/me").permitAll()
                                .requestMatchers(HttpMethod.PUT, "/users/me/updateUser").permitAll()
                                .requestMatchers(HttpMethod.PUT, "/userModules/me/addUserModule", "/userModules/me/updateUserModule").permitAll()
                                .requestMatchers(HttpMethod.DELETE, "/userModules/me/deleteUserModule").permitAll()
                                ...
                                .requestMatchers(HttpMethod.PUT, "/auth/delete").permitAll()
...
//                        .requestMatchers(HttpMethod.POST, "/modules/import").hasAnyRole("ADMIN_IMPORT")
    ...
    CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(List.of(
                ...
                "http://localhost:8082",
                "http://localhost:8082",
                "https://module-content-tracker-backend-production.up.railway.app",
                "https://module-content-tracker-ui-production.up.railway.app",
                "https://module-content-tracker.com"
                ));
